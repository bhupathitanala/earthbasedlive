...
const RecentlyAdded = ({recentlyAddedData, banners, shopshowModal, setShopshowModal}) => {
	...
	// props
	// const { recentlyAddedData, banners } = props;
	...
	return (
		<>
			...
			<div className='hello top_pick_minus_space d-none d-lg-none'>
				<div className='container'    >
					<h6 className='only_sm_heaiding_h6 '>Recently Added</h6>
				</div>
				<div className='container'>
					<div className='hello'>
