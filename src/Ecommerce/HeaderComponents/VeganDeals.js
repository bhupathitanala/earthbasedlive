...
const VeganDeals = ({ecoFriendlyData, banners, shopshowModal, setShopshowModal}) => {
	...
	// props
	// const { ecoFriendlyData, banners } = props;
						...
						<div className='row roling_marg d-flex flex-row justify-content-between'>
							<div className='col-md-12'>
								<div className='row roling_marg'>
									...
									{ecoFriendlyData?.length > 0 && ecoFriendlyData?.map((card, index) => (
