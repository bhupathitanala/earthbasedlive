      ...
      Apicalls.post('customer/login', data)
        .then((response) => {
          if (response.data.message === 'Login successful') {
            ...
            // }
            if (window.history.state.usr === 'register' || window.history.state.usr === 'Forgotpassword' || window.history.state.usr === null) {
            ...
            <div className='col-lg-6 col-md-6 login_first_section d-flex justify-content-center align-items-center my-5'>
              <div>
                ...
                <form style={{ fontFamily: 'fantasy' }}  onSubmit={handleSubmit}>
                  ...
                  <Button variant="success" type='submit' disabled={buttonLoading} size="lg" className="ps-5 pe-5 btn-lg w-100 mb-3 ">Sign in</Button>
