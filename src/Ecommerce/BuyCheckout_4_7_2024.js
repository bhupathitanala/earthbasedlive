...
function Buycheckout() {
    ...
    const buyProductItem = async (finalamount, shipping_charges, cod_charges) => {
                ...
                <div id="collapseTwo" className="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#checkoutAccordion" >
                    ...
                    <div className='d-flex flex-column'>
                                ...
                                <div className='d-flex justify-content-end'>
                                    <button className='ind_rupees' onClick={() => buyProductItem(finaltotal, totalShippingCharges, totalCodCharges)}>Place Order</button>
