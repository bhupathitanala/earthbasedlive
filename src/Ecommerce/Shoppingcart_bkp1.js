                            ...
                            {cartItems.map((item, index) => (
                                <tr key={item.ID}>
                                    {item.productType === "simple" && (
                                        ...
                                        <td>₹ {item.salePrice === "" ? item.price : item.salePrice * item.quantity}</td>
                                    ...
                                    {item.productType === "variable" && (
                                        ...
                                        {/* {
                                          item.salePrice === "" ?  (<td>₹ {(item.price * item.quantity)}</td>) : <td>₹ {(item.salePrice * item.quantity)}</td>
                                        } */}
                                        <td>₹ {item.salePrice === "" ? item.price : item.salePrice * item.quantity}</td>
                        ...
                        <div className="col-12">
                            <div className='d-flex sub_total_div'>
                                ...
                                <p className='para_text_checkout'>
                                        ₹{cartItems.reduce((total, item) => total + (item.salePrice === "" ? item.price : item.salePrice) * item.quantity, 0).toFixed(2)}
                                </p>
