                    ...
                    <div className='col-lg-6 col-md-12 col-sm-12'>
                        ...
                        <div className='d-flex flex-row justify-content-start'>
                            ...
                            <div className='col-12'>
                                ...
                                <button type="button" className="buynow_button_product_page" style={{border:"1px solid green",background:"white",color:"green"}} onClick={() => addToCartItems(product)} disabled={pincodeVerifyDisable.cartButton === 1}>Add to cart</button>
