        ...
        <div className='container'>
          <div className='row d-flex flex-row justify-content-evenly'>
            <div className='col-lg-6 col-xs-12 col-sm-12 col-md-6'>
              <div className='flipbook_section'>
                <Flipbook width={300} height={400} ref={book} className='flip_book'>
                  ...
                  <img src={bv33} alt="BV-1" className='img-fluid' />
                ...
                <div className='text-center flip_buttons' style={{ marginTop: '5px', marginTop:"0px", display:"flex", justifyContent:"space-around" }}>
                  <button onClick={() =>
                    book.current.pageFlip().flipPrev()} className='btn btn-success mx-2 mt-5' id='must_move'><i class="bi bi-arrow-left-square-fill"></i></button>
                  <button onClick={() =>
                    book.current.pageFlip().flipNext()} className='btn btn-success mx-2 mt-5'  id='must_move'><i class="bi bi-arrow-right-square-fill"></i></button>
              ...
              <div className='row justify-content-evenly mt-4'>
                ...
                <div class="col-lg-3   share-buttons"   style={{ height: '40px' }}>
            ...
            <div className='col-lg-5 col-xs-12 col-sm-12 col-md-6 flip_content_text d-flex flex-column justify-content-center'>
              ...
              <a href="/basic-vichaar" style={{ textDecoration: 'none', color: 'inherit' }}>
                <button variant="success" className='mt-3 first_edition hover_bg'  style={{ fontSize:"14px"}} >1st Edition
