                ...
                {selectedProducts && selectedProducts.map((product, index) => (
                    <div key={index}>
                        ...
                        <p>SKU: {product.sku}</p>
                            ...
                            {
                               product.sale_price!='' && (product?.price - product?.sale_price!=0) ? (<p className='product_page_price'><del>₹ {product.price}</del><br /> ₹ {product.sale_price}</p>) : (<p className='product_page_price'>₹ {product.price}</p>) 
                            }
