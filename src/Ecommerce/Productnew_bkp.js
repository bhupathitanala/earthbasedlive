    ...
    useEffect(() => {
        ...
        if (window.location.pathname.split('/')[2]) {
            Promise.all([
                ...
                // Promise.all([
                //     Apicalls.get('products/mcID/' + data.data.mcID)
            ...
            <div className='container'>
                <div className='row'>
                    ...
                    <div className='col-lg-2 product_page_min_images'>
                        ...
                        {/* {productAllImages.map((image, index) => (
                            <img
                            key={index}
                            src={image}
                            src={`${post_url}${isHovered ? 'hoverimages/' + product.hover_img : 'productimages/' + product.main_img}`}
                            alt={`Image ${index + 1}`}
                        ...
                        {/* {
                                product?.productImages?.map((item, index) => {
                                    if (index !== 0) {
                                        return <div className='d-none d-lg-block'> <img src={`${post_url + 'productimages/'+ product?.productImages?.[index]}`} alt={product?.title} className='img-fluid only_image_padding_need' onClick={() => handleImageClick1(index)} /></div>
                                    }
                                })
                            } */}
                ...
                <img 
                    ...
                    onMouseOver={() => handleImageClick1(post_url + 'productimages/' + image)} 
                />
            ))} */}
                    ...
                    <div className='col-lg-5 col-md-12 col-sm-12'>
                        ...
                        <div className='d-none d-lg-block'>
                            ...
                            <p className='product_page_price'>₹{(product?.price - product?.discount) }</p>
                        </div>
                        ...
                        <div className="row mt-2">
                            ...
                            <ul className="list-inline">
                                ...
                                product?.variables.map((variation, index) => (
                                    ...
                                    <button
                                        className={`btn btn-info ${selectedAttribute === index ? 'active' : ''}`}
                        ...
                        <div className="row">
                            ...
                            {selectedAttribute !== null && (
                                ...
                                <div className="card-body" >
                                    {/* <strong>Price:</strong> ₹{product.variables[selectedAttribute].price},<br /> */}
                                    {/* <strong>Sale Price:</strong> ₹{product.variables[selectedAttribute].sale_price},<br /> */}
                                    <div className='d-none d-lg-block'>
                                        <strong>SKU:</strong> {product.variables[selectedAttribute].sku}
                                        {/* <div className='d-flex flex-row'>
                                            <p className='produt_page_starts'>{'⭐'.repeat(product.rating)}</p>
                                           
                                        </div> */}
                                        {/* <p className='product_page_price'>₹{product?.price}</p> */}
                                        {product.variables[selectedAttribute].sale_price > 0 ? 
                                            (<p><del>₹{product.variables[selectedAttribute].price}</del></p>) : '' 
                                        }
                                        <p className='product_page_price'>₹{(product.variables[selectedAttribute].price - product.variables[selectedAttribute].sale_price) }</p>
                                        <p><strong>{product.variables[selectedAttribute].quantity}</strong>  in Stock</p>
                                        <div className="input-group" style={{width: "28%"}}>
                                            <input
                                                ...
                                                min="1" // Set the minimum value allowed for the quantity
                                                width={20}
                                            />
