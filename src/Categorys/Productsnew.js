...
const Products = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            try {
                ...
                if (selectedSubCategory === 'All') {
                    response = await Apicalls.get('products/mcID/' + selectedCategory, {
                        params: {
                            page: currentPage,
                    ...
                    response = await Apicalls.get('products/scID/' + selectedSubCategory, {
                        params: {
                            page: currentPage,
                            per_page: productsPerPage
                        }
                ...
                setTotalProducts(response.data.total_count); // Set total count of products
                setIsLoading(false);
            } catch (error) {
        ...
        fetchProducts();
    }, [currentPage, selectedCategory, selectedSubCategory, productsPerPage]);
                    ...
                    {isLoading ? (
                        ...
                        <div className="container my-4">
                            ...
                            {products.length > 0 ? (
                                ...
                                //         totalItems={totalProducts} // Replace with actual total count from API
                                //         paginate={paginate}
                                //     />
                                // </div>
                                <Pagination totalItems={totalProducts} itemsPerPage={productsPerPage} setCurrentPage={setCurrentPage} currentPage={currentPage} />
