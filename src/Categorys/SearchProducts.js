...
const Products = () => {
    ...
    useEffect(() => {
        ...
        categoryId = 1;
        Promise.all([
            Apicalls.get('category/' + categoryId),
    ...
    useEffect(() => {
        ...
        // let title = 'abc'
        Promise.all([
            Apicalls.get('search/filterdata?title=' + title)
        ]).then(([productsData]) => {
                ...
                <div className="col-2 position-sticky vh-100 side_nav d-flex flex-row justify-content-center d-none d-lg-block ">
                    <div className="sidebar-content overflow-y-auto overflow-x-hidden vh-100">
                        <div className="text-center">
                            ...
                            <div className="col-12 my-5 d-lg-none">
        ...
        <div className="main-row">
            ...
            <div className="col-12 col-lg-10">
                    <div className="d-none d-lg-block text-center mt-4">
                        <h2 className="Shoppage_Heading1">Search Results</h2>
                    </div>
