...
export default function RecipiesDetailsScreen() {
    ...
    useEffect(() => {
        Promise.all([
            Apicalls.get('recipies/' + window.location.pathname.split('/')[2]),
            Apicalls.get('recipies/hot/1'),
            Apicalls.get('recipies/trending/1'),
