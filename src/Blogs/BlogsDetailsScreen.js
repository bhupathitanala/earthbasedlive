...
export default function BlogsDetailsScreen() {
    ...
    useEffect(() => {
        Promise.all([
            Apicalls.get('blogs/' + window.location.pathname.split('/')[2]),
            Apicalls.get('blogs/hot/1'),
            Apicalls.get('blogs/trending/1'),
    ...
    // const sanitizedHTML = this.sanitizeHTML(blog.description);
    return (
        <>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-lg-8 col-md-8 col-sm-12'>
                            ...
                            {blog.img_urls && <img src={post_url + "blogimages/" + JSON.parse(blog.img_urls)[0]} alt="Banner" className='img-fluid' />}
            ...
            <div className='blogdetails_section2 mt-5' style={{ background: '#F9F7F080' }} hidden>
                <div className="container">
                    <div className='row'>
                        <div className='col-lg-8 col-md-8 col-sm-12'>
